...
Export [4D Write pro](https://us.4d.com/4D-write-pro) documents as PDF (4D v18 R4)

Find more information on the [blog post](https://blog.4d.com/4d-write-pro-direct-export-to-pdf/).
